    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 flex flex-col gap-5">
        ...
        <div class="relative">
            <button type="button"
                ...
                class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-main-light dark:text-text-main-dark hover:bg-background-light dark:hover:bg-[#2a4034] transition-colors font-medium group">
                <span class="material-symbols-outlined text-text-secondary-light dark:text-text-secondary-dark group-hover:text-primary transition-colors">
                    local_shipping
                </span>
                <span class="sidebar-text">Logistics</span>
                <span id="arrow"
                    class="material-symbols-outlined ml-auto text-text-secondary-light dark:text-text-secondary-dark group-hover:text-primary transition-transform duration-300 sidebar-text">
                    keyboard_arrow_down
                </span>
            </button>
            <!-- Dropdown -->
            <div id="logisticsDropdown"
                class="hidden mt-1 ml-10 space-y-1 sidebar-text">
                <a href="<?php echo getRelativePath('Admin/Logistics/'); ?>"
                    class="block px-3 py-2 rounded-md text-sm hover:bg-background-light dark:hover:bg-[#2a4034] transition">
                    Live Tracking
                </a>
                <a href="<?php echo getRelativePath('Admin/Logistics/'); ?>"
                    class="block px-3 py-2 rounded-md text-sm hover:bg-background-light dark:hover:bg-[#2a4034] transition">
