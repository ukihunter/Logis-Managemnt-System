...
<body class="bg-background-light dark:bg-background-dark text-[#0d1b12] dark:text-gray-100 font-display transition-colors duration-200">
                ...
                <div class="flex flex-col h-full">
                    ...
                    <form id="userForm" class="flex-1 p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="full_name" required placeholder="John Doe" class="w-full px-4 py-2.5 rounded-lg border border-[#e7f3eb] dark:border-gray-600 bg-white dark:bg-gray-800 text-[#0d1b12] dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-primary focus:border-transparent" />
                        </div>

                        <!-- Email -->
                        <div>
                            <label class="block text-sm font-bold text-[#0d1b12] dark:text-white mb-2">Email Address *</label>
                            <input type="email" name="email" required placeholder="john@example.com" class="w-full px-4 py-2.5 rounded-lg border border-[#e7f3eb] dark:border-gray-600 bg-white dark:bg-gray-800 text-[#0d1b12] dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-primary focus:border-transparent" />
                        </div>

                        <!-- Username -->
                        <div>
                            <label class="block text-sm font-bold text-[#0d1b12] dark:text-white mb-2">Username *</label>
                            <input type="text" name="username" required placeholder="johndoe" class="w-full px-4 py-2.5 rounded-lg border border-[#e7f3eb] dark:border-gray-600 bg-white dark:bg-gray-800 text-[#0d1b12] dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-primary focus:border-transparent" />
                        </div>
    ...
    <script>
        ...
        function showNotification(message, type = 'success') {
            ...
            if (type === 'success') {
                content.className = 'flex items-center gap-3 min-w-[320px] px-4 py-3 rounded-lg shadow-lg bg-primary text-white';
                icon.textContent = 'check_circle';
            } else if (type === 'error') {
                content.className = 'flex items-center gap-3 min-w-[320px] px-4 py-3 rounded-lg shadow-lg bg-red-500 text-white';
                icon.textContent = 'error';
            } else if (type === 'warning') {
                content.className = 'flex items-center gap-3 min-w-[320px] px-4 py-3 rounded-lg shadow-lg bg-orange-500 text-white';
            ...
            fetch('user_handler.php', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.querySelector('[name="business_name"]').value = user.business_name || '';
                        ...
                        document.querySelector('[name="password"]').placeholder = 'Leave blank to keep current password';
